...
write.csv(outer_2, "output_data/outer_2_mean.csv")
...
write.csv(outer_2, "output_data/outer_2_max.csv")
...
write.csv(outer_2, "output_data/outer_2_min.csv")
...
write.csv(outer_2, "output_data/outer_2_wbgt_mean.csv")
...
write.csv(outer_2, "output_data/outer_2_wbgt_max.csv")
...
write.csv(outer_2, "output_data/outer_2_wbgt_min.csv")
