...
stub2 <- "climate/provide_urban_climate_data/"
setwd(stub2)
...
indicator = c("urbclim-cooling-degree-hours",
              "urbclim-T2M-daily-mean-max",
              "urbclim-T2M-daily-mean-min")
